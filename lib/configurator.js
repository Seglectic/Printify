...
const getClientPluginsFromParsedConfig = nextParsedConfig => (
  Array.isArray(nextParsedConfig.clientPlugins)
    ? nextParsedConfig.clientPlugins
...
const clientPlugins = getClientPluginsFromParsedConfig(parsedConfig);
...
module.exports = {
  ...
  getClientPluginsFromParsedConfig,
};
